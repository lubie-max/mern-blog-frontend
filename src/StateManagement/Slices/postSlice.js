...
export const getPostsOfUser = createAsyncThunk(
    'userPosts',
    async () => {
        const response = await axios.get(`http://localhost:5000/api/blogs/user/${localStorage.userId}/`)
        const data = await response.data
...
export const addPost = createAsyncThunk(
    ...
    async (postData) => {
        const response = await axios(
            {
                method: 'post',
                url: `http://localhost:5000/api/blogs/new-blog/`,
                data: postData
            })
...
export const updatePost = createAsyncThunk(
    ...
    async (postData ) => {
        ...
        const response = await axios.put(`http://localhost:5000/api/blogs/update/${localStorage.postId}`,postData )
        const data = await response.data
